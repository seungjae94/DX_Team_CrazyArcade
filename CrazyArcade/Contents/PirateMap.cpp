...
void APirateMap::CreatePirateBoxs()
{
	...
	CreateBox({ 0, 1 }, MapImgRes::block_Pirate_box1);
	...
	CreateBox({ 0, 8 }, MapImgRes::block_Pirate_box1);
	...
	CreateBox({ 1, 3 }, MapImgRes::block_Pirate_box1);
	...
	CreateBox({ 2, 4 }, MapImgRes::block_Pirate_box1);
	CreateBox({ 2, 11 }, MapImgRes::block_Pirate_box1);
	...
	CreateBox({ 3, 12 }, MapImgRes::block_Pirate_box1);
	...
	CreateBox({ 4, 7 }, MapImgRes::block_Pirate_box1);
	...
	CreateBox({ 5, 7 }, MapImgRes::block_Pirate_box1);
	CreateBox({ 5, 8 }, MapImgRes::block_Pirate_box1);

	CreateBox({ 6, 0 }, MapImgRes::block_Pirate_box1);
	CreateBox({ 6, 4 }, MapImgRes::block_Pirate_box1);
	CreateBox({ 6, 5 }, MapImgRes::block_Pirate_box1);
	CreateBox({ 6, 7 }, MapImgRes::block_Pirate_box1);
	CreateBox({ 6, 8 }, MapImgRes::block_Pirate_box1);
	CreateBox({ 6, 9 }, MapImgRes::block_Pirate_box1);
	...
	CreateBox({ 7, 8 }, MapImgRes::block_Pirate_box1);
	...
	CreateBox({ 9, 5 }, MapImgRes::block_Pirate_box1);
	CreateBox({ 9, 6 }, MapImgRes::block_Pirate_box1);
	CreateBox({ 9, 7 }, MapImgRes::block_Pirate_box1);
	CreateBox({ 9, 8 }, MapImgRes::block_Pirate_box1);
	...
	CreateBox({ 14, 2 }, MapImgRes::block_Pirate_box1);
	...
	CreateBox({ 1, 5 }, MapImgRes::block_Pirate_box2);
...
void APirateMap::CreatePirateMoveBoxs()
{
	...
	CreateMoveBox({ 4 , 11 }, MapImgRes::block_Pirate_box0);
	CreateMoveBox({ 5 , 11 }, MapImgRes::block_Pirate_box0);
	CreateMoveBox({ 6 , 11 }, MapImgRes::block_Pirate_box0);
