...
void APirateMap::LevelStart(ULevel* _PrevLevel)
{
	...
	CreateAnimationWall({ 6,6 }, MapImgRes::block_Pirate_flag);
	CreateHollowWall({ 7,6 });
	CreateHollowWall({ 8,6 });
}
...
void APirateMap::CreatePool(int _x, int _y)
{
...
void APirateMap::CreateForestLeafsAndBushs()
{
	//leaf1
	...
	CreateBox({ 13,  7 }, MapImgRes::block_forest_leef2);
	CreateBox({ 14,  0 }, MapImgRes::block_forest_leef2);
...
void APirateMap::CreateForestMoveBoxs()
{
